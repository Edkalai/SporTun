...
<script type="text/javascript" src="https://fr.tutiempo.net/s-widget/l_Jy11xkB1B8DjcQGUKbuDjDDDjWa1L1YFrYEdEsi5a1z"></script>
    ...
    ?>
                                <a href="blogs-details.php?idNewsArticle=<?PHP echo $row['idNewsArticle']; ?>"><img class="d-block w-100" src="assets/img/<?PHP echo $row['urlImage']; ?>" alt="slide"></a>
    ...
    ?>
                        <div class="news-container">
                            <img src="assets/img/<?PHP echo $row['urlImage']; ?>">
